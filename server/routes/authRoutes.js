...
router
  ...
  .post(async (req, res) => {
    try {
      req.body.firstName = helper.stringVerifyer(
        "First Name",
        req.body.firstName,
        true,
        2,
      ...
      req.body.lastName = helper.stringVerifyer(
        "Last Name",
        req.body.lastName,
        true,
        2,
      ...
      req.body.password = helper.stringVerifyer(
        "Password",
        req.body.password,
        false,
        8
      ...
      req.body.userType = helper.validValues(
        "UserType",
